...
"""
access_course documentation build configuration file.
...
project = 'access_course'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Access edX Course from Wordpress'
...
#
# html_title = 'access_course v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'access_course'),
                os.path.join(root_path, 'access_course/migrations')])
